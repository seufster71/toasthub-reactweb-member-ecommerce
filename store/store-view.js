...
export default function StoreView({itemState, fields, texts, labels, onChangeLogin,
  ...
  fieldBlurEvent, buttonClick, handleChange, changeView }) {
	...
	let header = "";
	if (itemState.prefTexts.EC_STORE_PAGE != null && itemState.prefTexts.EC_MARKET_PAGE.EC_STORE_PAGE_HEADER != null) {
		header = itemState.prefTexts.EC_MARKET_PAGE.EC_STORE_PAGE_HEADER.value + "XyX";
	}
        ...
        <section className="py-5">
            <div className="container px-4 px-lg-5 mt-5">
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                	<CardTile title="Ed's Buds (Florida)" pickupDesc="*Local Pickup Only*" imgSrc="https://dummyimage.com/450x300/dee2e6/6c757d.jpg" url="/member/ec-storeinventory" urlDesc="Shop"/>
                   	...
                   	<CardTile title="Lydia's Honey Pine Farm (Flordia)" pickupDesc="*Local Pickup Only*" imgSrc="https://dummyimage.com/450x300/dee2e6/6c757d.jpg" url="/member/ec-storeinventory" urlDesc="Shop"/>
