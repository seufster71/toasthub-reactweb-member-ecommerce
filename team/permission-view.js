...
export default function ECPermissionView({itemState, appPrefs, onListLimitChange,
	onSearchChange, onSearchClick, onPaginationClick, onOrderBy, onOption, 
	closeModal, inputChange, goBack, session}) {

	let columns = [];
	if (itemState.prefLabels != null && itemState.prefLabels.EC_PERMISSION_PAGE != null) {
		columns = itemState.prefLabels.EC_PERMISSION_PAGE;
	}
	let group = "TABLE1";
	...
	if (itemState.prefTexts.EC_PERMISSION_PAGE != null && itemState.prefTexts.EC_PERMISSION_PAGE.EC_PERMISSION_PAGE_HEADER != null) {
		header = itemState.prefTexts.EC_PERMISSION_PAGE.EC_PERMISSION_PAGE_HEADER.value;
	}
