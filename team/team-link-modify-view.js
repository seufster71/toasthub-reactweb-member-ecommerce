...
export default function ECTeamLinkModifyView({itemState, appPrefs, onSave, onCancel, inputChange}) {
    
	let formName = "EC_TEAM_PRODUCT_FORM";
...
ECTeamLinkModifyView.propTypes = {
