...
export default function ECMemberView({itemState, appPrefs, onListLimitChange,
	onSearchChange, onSearchClick, onPaginationClick, onOrderBy, onOption, 
	closeModal, inputChange, goBack, session}) {

	let columns = [];
	if (itemState.prefLabels != null && itemState.prefLabels.EC_MEMBER_PAGE != null) {
		columns = itemState.prefLabels.EC_MEMBER_PAGE;
	}
	let group = "TABLE1";
	...
	if (itemState.prefTexts.EC_MEMBER_PAGE != null && itemState.prefTexts.EC_MEMBER_PAGE.EC_MEMBER_PAGE_HEADER != null) {
		header = itemState.prefTexts.EC_MEMBER_PAGE.EC_MEMBER_PAGE_HEADER.value;
	}
